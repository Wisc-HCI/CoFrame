    ...
    tabs.push(
        {
            ...
            contents:<div>
                ...
                <Blurb highlight="rgb(50,50,50)">
                    ...
                    {' '}
                    <Glossary.Processes primaryColor={primaryColor}/>, frequently with additional information specifying how they are arranged.
                ...
                {frame === 'quality' && (
                    <Blurb highlight={primaryColor}>
                        ...
                        <Glossary.Processes primaryColor={primaryColor}/>{' '}
                         take time to execute, so if you start a process, you won’t be able to use their outputs until the process is finished and the time is up. 
