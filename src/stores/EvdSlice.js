...
export const EvdSlice = (set, get) => ({
  ...
  programSpec: {
    drawers: [
      ...
      { title: "Actions", dataType: DATA_TYPES.INSTANCE, objectTypes: ['delayType', 'gripperType', 'machineInitType', 'processStartType', 'processStopType', 'processWaitType', 'moveTrajectoryType', 'moveUnplannedType', 'breakpointType'], icon: PrimitiveIconStyled }
    ],
