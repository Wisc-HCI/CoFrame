...
export const EvdSlice = (set, get) => ({
  ...
  programSpec: {
    drawers: [
      ...
      { title: "Actions", dataType: DATA_TYPES.INSTANCE, objectTypes: ['delayType', 'moveGripperType', 'machineInitType', 'processStartType', 'processStopType', 'processWaitType', 'moveTrajectoryType', 'breakpointType'], icon: PrimitiveIconStyled }
    ],
