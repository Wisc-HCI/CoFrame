...
export const ReviewSlice = (set, get) => ({
    ...
    issueSettings: {
        'eePoseWarn': {id: 'eePoseWarn', frame: 'safety', type: "text", name: "End Effector Pose Warning Level", value: 2, min: 0},
        'eePoseErr': {id: 'eePoseErr', frame: 'safety', type: "text", name: "End Effector Pose Error Level", value: 5, min: 0},
        'collisionWarn': {id: 'collisionWarn', frame: 'safety', type: "text", name: "Collision Warning Level", value: 0.05, min: 0, max: 1},
        'collisionErr': {id: 'collisionErr', frame: 'safety', type: "text", name: "Collision Error Level", value: 0, min: 0, max: 1},
        'occupancyWarn': {id: 'occupancyWarn', frame: 'safety', type: "text", name: "Occupancy Warning Level", value: 0.05, min: 0, max: 1},
        'occupancyErr': {id: 'occupancyErr', frame: 'safety', type: "text", name: "Occupancy Error Level", value: 0, min: 0, max: 1},
        'jointMaxSpeed': {id: 'jointMaxSpeed', frame: 'performance', type: "text", name: "Max Joint Speed", value: 10, min: 0},
        'jointSpeedWarn': {id: 'jointSpeedWarn', frame: 'performance', type: "text", name: "Joint Speed Warning Level (% of max speed)", value: 0.1, min: 0, max: 1},
        'jointSpeedErr': {id: 'jointSpeedErr', frame: 'performance', type: "text", name: "Joint Speed Error Level (% of max speed)", value: 0.5, min: 0, max: 1},
        'eeSpeedWarn': {id: 'eeSpeedWarn', frame: 'performance', type: "text", name: "End Effector Speed Warning Level", value: 0.3, min: 0, max: 1},
        'eeSpeedErr': {id: 'eeSpeedErr', frame: 'performance', type: "text", name: "End Effector Speed Error Level", value: 0.45, min: 0, max: 1},
        'payloadWarn': {id: 'payloadWarn', frame: 'performance', type: "text", name: "Robot Payload Warning Level", value: 2.5},
        'payloadErr': {id: 'payloadErr', frame: 'performance', type: "text", name: "Robot Payload Error Level", value: 3},
        'spaceUsageWarn': {id: 'spaceUsageWarn', frame: 'performance', type: "text", name: "Space Usage (%) Warning Level", value: 1, min: 0, max: 100},
        'spaceUsageErr': {id: 'spaceUsageErr', frame: 'performance', type: "text", name: "Space Usage (%) Error Level", value: 20, min: 0, max: 100},
