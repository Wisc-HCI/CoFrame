...
export const ReviewSlice = (set, get) => ({
    ...
    issueSettings: {
        ...
        'payloadWarn': {id: 'payloadWarn', frame: 'performance', name: "Robot Payload Warning Level", value: 5},
        'payloadErr': {id: 'payloadErr', frame: 'performance', name: "Robot Payload Error Level", value: 6.6},
