...
namespace EvD 
{
    ...
    public class Context : Node
    {
        ...
        : base(appendType ? "context." + type : type, name, uuid, parent, appendType)
        {
            ...
            this.waypoints = (waypoints != null) ? waypoints : List<Waypoint>();
            this.trajectories = (trajectories != null) ? trajectories : List<Trajectory>();
        }
        ...
        public Machine GetThing(string uuid)
        {
            return _things[uuid];
        }
