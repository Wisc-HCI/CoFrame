...
public class TraceRendererScript : MonoBehaviour
{
    ...
    public class PathEntry
    {
        ...
        public Dictionary<string, List<EvD.Data.TraceDataPoint>> data = new Dictionary<string, List<EvD.Data.TraceDataPoint>>();
    ...
    public void OnUpdate(EvD.Data.Trace t)
    {
    ...
    private void UpdateSubset(string subset, EvD.Data.Trace t)
    {
