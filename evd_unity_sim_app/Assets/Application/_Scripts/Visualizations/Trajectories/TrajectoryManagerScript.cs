...
public class TrajectoryManagerScript : MonoBehaviour
{
    ...
    public void OnTrajectoryCreate(EvD.Data.Trajectory trajectory)
    {
        ...
        foreach(var w in trajectory.waypointUuids)
        {
            ways.Add(markerManager.GetMarker(w).GetComponent<TrajectoryPointScript>());
            AddTrajectoryToMarkerMap(w, trajectory.uuid);
        }
    ...
    public void OnAddWaypoint(EvD.Data.Trajectory trajectory, string waypointUuid)
    {
    ...
    public void OnDeleteWaypoint(EvD.Data.Trajectory trajectory, string waypointUuid)
    {
        if (trajectories.ContainsKey(trajectory.uuid))
        {
