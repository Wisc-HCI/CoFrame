    ...
    namespace Data
    {
        ...
        public class Pose : Node
        {
            ...
            */
            ...
            public static Pose FromRos(RosSharp.RosBridgeClient.MessageTypes.Geometry.Pose p)
            {
                return new Pose(Position.FromRos(p.position), Orientation.FromRos(p.orientation));
            }

            public RosSharp.RosBridgeClient.MessageTypes.Geometry.Pose ToRos()
            {
                var msg = new RosSharp.RosBridgeClient.MessageTypes.Geometry.Pose();
            ...
            */
            ...
            public Position position
            {
                ...
                set
                {
                    ...
                    {
                        if (value == null) {
                            throw new System.Exception("Position cannot be null");
                        }

                        if (_position != null) {
                            _position.RemoveFromCache();
                        }
            ...
            public Orientation orientation
            {
                ...
                set
                {
                    ...
                    {
                        if (value == null) {
                            throw new System.Exception("Orientation cannot be null");
                        }

                        if (_orientation != null) {
                            _orientation.RemoveFromCache();
                        }
            ...
            {
                position.RemoveFromCache();
                orientation.RemoveFromCache();
            ...
            */
            ...
            {
                position.LateConstructUpdate();
                orientation.LateConstructUpdate();
        ...
        public class Position : Node
        {
            ...
            */
            ...
            public static Position FromRos(RosSharp.RosBridgeClient.MessageTypes.Geometry.Point p)
            {
                return new Position((float)p.x, (float)p.y, (float)p.z);
            }
            ...
            public RosSharp.RosBridgeClient.MessageTypes.Geometry.Point ToRos()
            {
                var msg = new RosSharp.RosBridgeClient.MessageTypes.Geometry.Point();
                msg.x = x;
                msg.y = y;
                msg.z = z;
                return msg;
        ...
        public class Orientation : Node
        {
            ...
            */
            ...
            public static Orientation FromRos(RosSharp.RosBridgeClient.MessageTypes.Geometry.Quaternion q)
            {
                return new Orientation((float)q.x, (float)q.y, (float)q.z, (float)q.w);
            }
            ...
            {
                var msg = new RosSharp.RosBridgeClient.MessageTypes.Geometry.Quaternion();
                msg.x = x;
                msg.y = y;
                msg.z = z;
                msg.w = w;
