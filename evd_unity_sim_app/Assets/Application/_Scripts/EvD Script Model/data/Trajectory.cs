    ...
    namespace Data
    {
        ...
        public class Trajectory : Node
        {
            ...
            */
            ...
            private List<string> _waypointUuids = new List<string>();
            ...
            */
            ...
            {
                var waypointUuids = new List<string>();
                foreach (var wp in (List<string>)dct["waypoint_uuids"])
                {
                    waypointUuids.Add(wp);
                }
            ...
            public override Dictionary<string,object> ToDict()
            {
                ...
                foreach (var wp in waypointUuids)
                {
                    dctWaypoints.Add(wp);
                }
            ...
            */
            ...
            public List<string> waypointUuids
            {
                get
                {
                    return _waypointUuids;
                }

                set
                {
                    if (_waypointUuids != value)
                    {
                        _waypointUuids = value;
            ...
            public void ReorderWaypoints(string uuid, int shift)
            {
                ...
                if (idx != -1)
                {
                    ...
                    if (shiftedIdx < 0 || shiftedIdx >= waypointUuids.Count)
                    {
                        throw new System.Exception("Index out of bounds");
                    }

                    var copy = waypointUuids[idx];
                    waypointUuids.RemoveAt(idx);
                    waypointUuids.Insert(shiftedIdx, copy);
            ...
            {
                int idx = -1;
                for (int i = 0; i < waypointUuids.Count; i++)
                {
                    if (waypointUuids[i] == uuid)
                    {
                        idx = i;
                        break;
                    }
            ...
            public override void Set(Dictionary<string,object> dct)
            {
                ...
                {
                    this.waypointUuids = (List<string>)dct["waypoint_uuids"];
                }
